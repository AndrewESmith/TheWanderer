...
describe('AudioSettings', () => {
    ...
    describe('rendering', () => {
        ...
        it('should show keyboard shortcut hint', () => {
            ...
            expect(screen.getByText('Keyboard shortcut: Ctrl/Cmd + M')).toBeInTheDocument();
        });
    });
    ...
    describe('volume controls', () => {
        ...
        it('should call setCategoryVolume when category volume slider changes', () => {
            ...
            expect(mockUseAudioSettings.setCategoryVolume).toHaveBeenCalledWith('movement', 0.5);
        });
    ...
    describe('close functionality', () => {
        ...
        it('should call onClose when overlay is clicked', () => {
            ...
            const overlay = screen.getByText('Audio Settings').closest('.audio-settings-overlay');
        ...
        it('should not call onClose when panel content is clicked', () => {
            ...
            const panel = screen.getByText('Audio Settings').closest('.audio-settings-panel');
    ...
    describe('accessibility', () => {
        ...
        it('should have proper form labels', () => {
            ...
            Object.keys(SOUND_CONFIG.categories).forEach(categoryKey => {
                const slider = screen.getByLabelText(new RegExp(SOUND_CONFIG.categories[categoryKey]!.name));
