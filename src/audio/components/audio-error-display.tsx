...
export function AudioErrorDisplay({
  ...
  return (
    <div
      className="audio-error-container"
      style={{
        padding: "10px",
        margin: "10px 0",
        backgroundColor: error
          ...
          : "#f0f8ff",
        border: `1px solid ${
          error ? "#ffcccc" : fallbackMode ? "#ffe0b2" : "#b3e0ff"
        }`,
        borderRadius: "4px",
        fontSize: "14px",
      }}
    >
      {error && (
        <div className="audio-error">
          ...
          <p>
            The game will continue to work, but sound effects may be limited or
            unavailable.
          </p>
        </div>
      )}
      ...
      {fallbackMode && !error && (
        <div className="audio-fallback">
          ...
          <p>
            Your browser has limited audio support. The game is using a
      ...
      {!autoplayAllowed && !error && !fallbackMode && (
        <div className="audio-autoplay">
          ...
          <p>Click anywhere on the game to enable sound effects.</p>
        </div>
      )}
      ...
      {showHelp && (
        ...
        >
          ...
          <ul style={{ paddingLeft: "20px", margin: "0" }}>
            ...
            <li>
              Check if your browser allows autoplay (Settings &gt; Site Settings
              &gt; Sound)
            </li>
            <li>
            ...
            <li>
              Use the keyboard shortcut Ctrl+M (or Cmd+M on Mac) to toggle mute
            </li>
          </ul>
        </div>
      )}
